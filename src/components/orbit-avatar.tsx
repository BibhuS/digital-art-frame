    ...
    >
      {items.map((it, i) => {
        ...
        return (
          ...
          >
            <div
              className="group grid place-items-center rounded-xl border border-border/70 bg-card/80 text-foreground shadow-lg shadow-primary/10 backdrop-blur-md transition hover:border-primary/60 hover:text-primary"
              style={{
                width: size,
                height: size,
  ...
  return (
    <div className="relative mx-auto aspect-square w-full max-w-[480px]">
      ...
      <div className="absolute inset-[14%]">
        <Ring items={RING_INNER} radius={110} duration={24} />
      </div>
      <div className="absolute inset-[2%]">
        <Ring items={RING_OUTER} radius={175} duration={38} reverse size={44} />
      </div>
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="relative">
          ...
          />
          <div className="relative grid h-32 w-32 place-items-center rounded-full border border-primary/40 bg-background/80 backdrop-blur-xl shadow-2xl shadow-primary/30">
            <div className="grid h-28 w-28 place-items-center rounded-full bg-gradient-to-br from-primary/30 via-background to-accent/30">
              <span className="bg-gradient-to-br from-foreground to-foreground/60 bg-clip-text font-mono text-3xl font-semibold tracking-tight text-transparent">
                BS
              </span>
            </div>
